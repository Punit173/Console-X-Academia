...
export default function Navbar() {
  ...
  const getThemeStyles = () => {
    switch (pathname) {
      ...
      default:
        // Default Dashboard/Home Theme (Original Primary Orange)
        return {
      ...
      {isMenuOpen && (
        <div className="mt-3 border-t border-white/10 pt-3 md:hidden">
          <div className="flex flex-col gap-2">
            ...
            {/* Mobile Install Now Button - Dynamic Gradient */}
            <a
              href="https://play.google.com/store/apps/details?id=com.akshat.academia"
              target="_blank"
              rel="noopener noreferrer"
              className={`w-full px-4 py-2 text-sm font-bold bg-gradient-to-r ${theme.installButton} text-white rounded-lg transition-all duration-200 flex items-center justify-center gap-2 active:scale-95`}
            >
              Install on
              <img
                src="https://img.icons8.com/?size=100&id=22982&format=png&color=ffffff"
